...
# Plot the data on a latitude and longitude scale
im = ax.contourf(lon, lat, var, transform=ccrs.PlateCarree(), cmap='Reds_r') # Reversed colormap to emphasize depletion
...
ax.set_title(r'Dissolved Oxygen ($mmol/m^{3}$C)')
...
plt.savefig('Output/DO.tif', format='tif')
